<!DOCTYPE htm<!DOCTYPE html><!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">
            ...
            <td> 
              <p data-placement="top" data-toggle="tooltip" title="Edit"> 
                <button  class="btn btn-primary btn-s" data-title="Edit" data-toggle="" data-target="#edit"> Update  
                  <a href="update.php?u_id=<?php echo $res['u_id']; ?>" class="glyphicon glyphicon-pencil">
                  </a> 
                </button> 
              </button> 
            </p>
            ...
            <td> 
              <p data-placement="top" data-toggle="tooltip" title="Edit"> 
                <button  class="btn btn-danger btn-s" data-title="Edit" data-toggle="" data-target="#edit"> Delete   
                  <a href="delete.php?n_id=<?php echo $res['n_id']; ?>" class="glyphicon glyphicon-trash">
                  </a> 
                </button> 
              </button> 
            </p>
