            ...
            <td> 
              <p data-placement="top" data-toggle="tooltip" title="Edit"> 
                <button  class="btn btn-primary btn-s" data-title="Edit" data-toggle="" data-target="#edit"> Update  
                  <a href="update.php?r_id=<?php echo $res['r_id']; ?>" class="glyphicon glyphicon-pencil">
                  </a> 
                </button> 
              </button> 
            </p>
            ...
            <td> 
              <p data-placement="top" data-toggle="tooltip" title="Edit"> 
                <button  class="btn btn-danger btn-s" data-title="Edit" data-toggle="" data-target="#edit"> Delete   
                  <a href="delete.php?r_id=<?php echo $res['r_id']; ?>" class="glyphicon glyphicon-trash">
                  </a> 
                </button> 
              </button> 
            </p>
